...
export default function MainWindowHome() {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col gap-3 overflow-hidden">
      ...
      <div className="grid min-h-0 flex-1 grid-cols-1 grid-rows-[minmax(0,1fr)_minmax(0,1fr)] gap-3 overflow-visible lg:grid-cols-[minmax(0,1.3fr)_minmax(0,3fr)] lg:grid-rows-1">
