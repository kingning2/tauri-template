...
import { ChevronLeft, ChevronRight, Shield, Smartphone, Wrench } from "lucide-react";
...
export default function LauncherHeroCarousel() {
  ...
  const subtitles = [t("slide1_subtitle"), t("slide2_subtitle"), t("slide3_subtitle")];
  ...
  return (
    <Card
      ...
      className={cn(
        "relative flex h-full min-h-0 cursor-pointer flex-col border-0",
    ...
    >
      ...
      <button
        ...
        className={cn(
          "absolute top-1/2 left-2 -translate-y-1/2 cursor-pointer p-2",
      ...
      <button
        ...
        className={cn(
          "absolute top-1/2 right-2 -translate-y-1/2 cursor-pointer p-2",
          "rounded-full border border-white/25 bg-white/10 backdrop-blur",
          "transition-all duration-300 ease-out",
          "z-20",
          showNav
      ...
      <div className="relative z-10 flex min-h-0 flex-1 flex-col px-5 pt-5 pb-8 sm:flex-row sm:items-stretch sm:gap-6 sm:pt-6 sm:pb-7">
        <div
          className="pointer-events-none relative flex min-h-0 flex-1 flex-col"
            ...
            <div className="flex min-w-0 flex-1 flex-col gap-4">
              <div className="flex items-start gap-4">
                ...
                <div className="min-w-0 space-y-1">
                  <CardTitle className="text-xl leading-snug font-semibold text-white sm:text-2xl">
                    {titles[active]}
                  </CardTitle>
